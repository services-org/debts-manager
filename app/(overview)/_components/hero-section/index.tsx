    ...
    return (
        <section className="animate-fade-in group relative mb-6 w-full overflow-hidden rounded-2xl bg-linear-to-br from-amber-50 to-amber-100 shadow-xl sm:mb-8 sm:rounded-3xl dark:from-slate-900 dark:to-slate-950">
            ...
            <div className="relative z-10 flex flex-col items-center gap-6 p-5 sm:gap-8 sm:p-8 md:flex-row md:justify-between md:p-12">
                {/* Left content */}
                <div className="flex flex-1 flex-col items-center gap-3 text-center sm:gap-4 md:items-start md:text-left rtl:md:items-end rtl:md:text-right">
                    {/* Badge */}
                    ...
                    {/* Description */}
                    <p className="max-w-lg text-sm text-slate-600 sm:text-base dark:text-slate-400">{t("hero.description")}</p>

                    {/* Stats row */}
                    <div className="mt-2 flex flex-wrap items-center justify-center gap-4 sm:mt-4 sm:gap-6 md:justify-start rtl:md:justify-end">
                        <div className="flex items-center gap-2">
                            ...
                            <div className="text-left rtl:text-right">
                                ...
                                <p className="text-xs font-semibold text-slate-800 sm:text-sm dark:text-white">
                                    {t("hero.realTime")}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <div className="text-left rtl:text-right">
                                <p className="text-[10px] text-slate-500 sm:text-xs dark:text-slate-500">{t("hero.manage")}</p>
                                <p className="text-xs font-semibold text-slate-800 sm:text-sm dark:text-white">
                                    {t("hero.allDebts")}
                                </p>
                            </div>
