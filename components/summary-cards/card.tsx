...
export const SummaryCard = ({ label, value, icon }: TSummaryCard) => (
	<Card
		className={`relative flex flex-col items-start bg-gradient-to-b from-sky-200 to-sky-50 border-2 border-sky-300 rounded-xl shadow-lg px-5 pt-6 pb-4 min-h-[120px] w-full max-w-xs transition-transform duration-200 hover:-translate-y-1 hover:shadow-2xl hover:border-sky-400 group`}>
